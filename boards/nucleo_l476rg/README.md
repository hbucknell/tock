...
For more details [visit NUCLEO-L476RG
website](https://www.st.com/en/evaluation-tools/nucleo-l476rg.html).

## Flashing the kernel

The kernel can be programmed using OpenOCD. `cd` into `boards/nucleo_l476rg`
directory and run:
